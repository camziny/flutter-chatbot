    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (sessionResponse.statusCode == 200) {
          ...
          await _authProvider.setSession(session, sessionResponse.body);
      ...
      print('Login error: $e');
      return AuthState(status: AuthStatus.failed, error: e.toString());
    }
  }
  ...
  Future<AuthState> register(String email, String password) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return AuthState(status: AuthStatus.userExists);
      }
      return AuthState(status: AuthStatus.failed);
    } catch (e) {
